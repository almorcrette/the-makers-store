...
object DbAdapter extends DbAdapterBase[ArrayBuffer[ItemInterface]] {
  ...
  private def write(table: String, data: ArrayBuffer[ItemInterface]) = {
  ...
  def getItems(): ArrayBuffer[ItemInterface] = {
